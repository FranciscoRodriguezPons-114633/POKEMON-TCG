...
public class GameAggregate {
    ...
    public Map<UUID, PlayerSetupState> setupByPlayer() {
        return setupByPlayer;
    }

    public void setSetupByPlayer(Map<UUID, PlayerSetupState> setupByPlayer) {
        this.setupByPlayer = setupByPlayer;
    }
    ...
    public TurnFlags turnFlags() {
        return turnFlags;
    }

    public void setTurnFlags(TurnFlags turnFlags) {
        this.turnFlags = turnFlags;
    }

    public Map<UUID, Integer> prizeCardsRemaining() {
        return prizeCardsRemaining;
    }

    public void setPrizeCardsRemaining(Map<UUID, Integer> prizeCardsRemaining) {
        this.prizeCardsRemaining = prizeCardsRemaining;
    }

    public Map<UUID, Integer> activeHp() {
        return activeHp;
    }

    public void setActiveHp(Map<UUID, Integer> activeHp) {
        this.activeHp = activeHp;
    }

    public Map<UUID, Integer> deckCardsRemaining() {
        return deckCardsRemaining;
    }

    public void setDeckCardsRemaining(Map<UUID, Integer> deckCardsRemaining) {
        this.deckCardsRemaining = deckCardsRemaining;
    }

    public Map<UUID, EnumSet<StatusCondition>> statusByPlayer() {
